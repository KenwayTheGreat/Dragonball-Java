...
public class World implements CellListener, Serializable {
	...
	private void moveTo(int row, int column) throws InterruptedException {
	...
	@Override
	public void onFoeEncountered(NonPlayableFighter foe) throws InterruptedException {
	...
	public void notifyOnFoeEncountered(NonPlayableFighter foe) throws InterruptedException {
		if (listener != null) {
